...
@WebServlet("/book_pc_repair")
public class book_pc_repair extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			PreparedStatement ps = con.prepareStatement("INSERT INTO service VALUES (null,'desktop repair','"+date+"','"+time+"',"+id+")");
