    ...
    <section class="search-bar">
        ...
        <div id="root1">
        	...
        	try {
				...
				String search_qry = session.getAttribute("cat").toString();
				
				Statement st = con.createStatement();
				
				ResultSet rs = st.executeQuery("SELECT * FROM producttb WHERE prod_category ='"+search_qry+"'");
            ...
            <div>
            	<%
            			if(count>0){
            				...
            				out.print("<button type='submit' class='addtocart'>Payment </button>");
