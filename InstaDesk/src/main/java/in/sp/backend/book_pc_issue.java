...
@WebServlet("/book_pc_issue")
public class book_pc_issue extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			PreparedStatement ps = con.prepareStatement("INSERT INTO service VALUES (null,'software issue','"+date+"','"+time+"',"+id+")");
